...
class textPreprocess():
    ...
    def Preprocessing(self,Modelpath):
        ...
        for item in self.content:
            # print(item[2])
            stopped_tokens = " ".join(i for i in item[2])
    ...
    def LDAModeling(self,Modelpath):
        ...
        IO.csv_writer(os.path.join(Modelpath, 'group45494Topics.csv'), list)
def main():

    Sourpath = os.getcwd()+"\\..\\Data\\GroupEvents\\Group_45494\\Group_45494_topics.csv"
